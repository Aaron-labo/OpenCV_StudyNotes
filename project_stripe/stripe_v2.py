...
#         ave_radius.append((ls[i]))
#     else:
#         ave_radius.append((list_radius[i]+list_radius[i+1])/2)

ave_center = (sum_center[0]/len_contour,sum_center[1]/len_contour)  # 计算圆心的平均值
...
# cv2.imwrite("E:\\Python\\OpenCV_StudyNotes\\picture\\test_2.png", )
cv2.waitKey(0)
